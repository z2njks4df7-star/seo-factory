...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="资产永续">
    <meta name="application-name" content="SEO Factory">
    ...
    <style>
        ...
        * { box-sizing: border-box; margin:0; padding:0; }
        ...
        @media (prefers-contrast: more) {
            :root { --fg: #ffffff; --accent2: #ff6b6b; }
        }
        @media (prefers-contrast: less) {
            :root { --fg: #cccccc; --accent2: #ff8787; }
        }
        /* Color scheme */
...
console.log("- Page Lifecycle API: freeze/resume 事件暂停/恢复新闻循环");
